...
export function Header(){
 ...
 return <>
  <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur">
    <div className="mx-auto flex h-28 max-w-7xl items-center justify-between px-5 lg:h-36 lg:px-8">
     <Link to="/" aria-label="TCMA home"><img src={logo.url} alt="The Creator Marketing Agency" className="h-[6.5rem] w-auto md:h-[7.8rem]" /></Link>
