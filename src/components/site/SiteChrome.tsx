 ...
 return <>
  <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur">
    <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:h-24 lg:px-8">
      <Link to="/" aria-label="TCMA home"><img src={logo.url} alt="The Creator Marketing Agency logo" className="h-12 w-auto md:h-16" /></Link>
